...
Процедура ОбработкаКоманды(ПараметрКоманды, ПараметрыВыполненияКоманды)
	...
	ДанныеНастроек = ДанныеНастроек(ПараметрКоманды);
	
	ПараметрыФормы = Новый Структура;
	ПараметрыФормы.Вставить("ДанныеНастроек", ДанныеНастроек);
...
&НаСервере
Функция ДанныеНастроек(СсылкаНаОбъект)
	
	ВсегоВерсий = 0;
	ПараметрыВерсионирования = Новый Структура("СерверES, ИндексES");
	
	ДанныеИнстанса = ПолучитьДанныеИнстансаХранения(СсылкаНаОбъект);
...
&НаСервере
Функция ПолучитьДанныеИнстансаХранения(СсылкаНаОбъект)
